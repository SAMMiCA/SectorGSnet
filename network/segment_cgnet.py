...
class Context_Guided_Network(nn.Module):
    ...
    def __init__(self, classes=2, M=3, N=21, dropout_flag=False):
        ...
        super().__init__()
        print("CG network")
        self.level1_0 = ConvBNPReLU(32, 32, 3, 2)  # feature map size divided 2, 1/2
        ...
        self.b1 = BNPReLU(32 + 32)

        # stage 2
        self.level2_0 = ContextGuidedBlock_Down(32 + 32, 64, dilation_rate=2, reduction=8)
        self.level2 = nn.ModuleList()
        for i in range(0, M - 1):
            self.level2.append(ContextGuidedBlock(64, 64, dilation_rate=2, reduction=8))  # CG block
        self.bn_prelu_2 = BNPReLU(128 + 32)

        # stage 3
        self.level3_0 = ContextGuidedBlock_Down(128 + 32, 128, dilation_rate=4, reduction=16)
